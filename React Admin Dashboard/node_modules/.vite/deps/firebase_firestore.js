...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  Rt(e, t) {
    if ("nullValue" in e)
      ...
      this.wt(e.stringValue, t), this.St(t);
    else if ("bytesValue" in e)
      this.ft(t, 30), t.bt(__PRIVATE_normalizeByteString(e.bytesValue)), this.St(t);
      ...
      "mapValue" in e ? __PRIVATE_isMaxValue(e) ? this.ft(t, Number.MAX_SAFE_INTEGER) : __PRIVATE_isVectorValue(e) ? this.vt(e.mapValue, t) : (this.Ct(e.mapValue, t), this.St(t)) : "arrayValue" in e ? (this.Ft(e.arrayValue, t), this.St(t)) : fail();
  }
  wt(e, t) {
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  Vn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r)
        if (this.Sn(t, s.fieldPath) && isArray(e2))
          r = this.bn(r, s, e2);
        else {
